        ...
        <div className={styles.content}>
                ...
                <div className={styles.rightSide}>
                    ...
                    <div className={styles.frame}>
                        <div className={styles.prices}>
                            ...
                            <span
                                className={product.discount ? styles.priceWithDisc : styles.price}>{product.price - product.price / 100 * product.discount} р.</span>
                        </div>
            ...
            <div className={styles.characteristics}>
                ...
                <div className={styles.details}>
                    ...
                    <p>Большое содержание аминокислот и микроэлементов
                        оказывает
                        ...
                        Следует учесть высокую калорийность продукта.</p>
                </div>
            </div>
        </div>
    </div>
